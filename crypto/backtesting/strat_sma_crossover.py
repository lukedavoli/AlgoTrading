...
class SMACrossover(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.sma_shortterm = bt.indicators.SimpleMovingAverage(self.datas[0], period=self.params.sma_short_length)
        self.sma_longterm = bt.indicators.SimpleMovingAverage(self.datas[0], period=self.params.sma_long_length)
